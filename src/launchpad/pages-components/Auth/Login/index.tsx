                    ...
                    <div className="flex flex-col-reverse lg:flex-row py-36 px-8 md:px-12 lg:px-18 xl:px-24 2xl:px-36 3xl:px-48 min-h-screen gap-8 lg:gap-16">
                        <div className="grid grid-col-1 lg:w-1/3 w-full text-white content-center">
                            ...
                            <div className="login-form">
                                <Form
                                    name="normal_login"
                                    className="login-form mt-14 w-full"
                                    initialValues={{
                                        remember: true,
                                    }}
                                >
                                    ...
                                    >
                                        <Input
                                            ...
                                            className="form-username h-14 text-[18px] font-medium w-full"
                                    ...
                                    <Form.Item>
                                        <Form.Item name="remember" valuePropName="checked" noStyle>
                                            <CustomCheckbox classes="customCheckbox inline-flex" />
                                        </Form.Item>

                                        <Link
                                            className="login-form-forgot float-right text-md xs:text-xl font-medium italic text-white mr-1"
                                            href=""
                                        >
                                            Forgot password?
                                        </Link>
