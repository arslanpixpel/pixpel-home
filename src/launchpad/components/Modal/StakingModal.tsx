...
const StakingModal = ({ showModal, setShowModal }: StakingModal) => {
            ...
            {showModal ? (
                <div className="fixed inset-0 z-10 overflow-x-auto">
                    ...
                    <div className="flex items-center px-4 py-6 min-h-screen">
                        <div className="relative flex flex-col w-full max-w-2xl mx-auto bg-app-black-modal rounded-xl shadow-lg px-12 py-12 text-lg">
                            <div className="flex items-center justify-center mb-6 text-2xl">LOCKED</div>
                            <div className="px-10">
                            ...
                            <div className="flex gap-2 justify-center">
                                <input type="checkbox" />
                                <label className="text-base text-gray-500">I have read and I agree</label>
                            </div>
                        </div>
                    </div>
                </div>
            ) : null}
            {<StakingSuccessModal showModal={showSuccessModal} setShowModal={setShowSuccessModal} />}
        </>
    );
};
