...
import bnb from "@launchpad/assets/icons/bnb.png";
import eth from "@launchpad/assets/icons/eth.png";
import btc from "@launchpad/assets/icons/btc.png";
import luna from "@launchpad/assets/icons/luna.png";
import StakingModal from "@launchpad/components/Modal/StakingModal";
...
const Staking = ({ scrollToRef }: Stacking) => {
                                    ...
                                    <tr key={idx}>
                                        <td className="py-3">
                                            <div className="flex gap-2 items-center">
                                                <Image src={staking.img} alt="token" className="md:w-10 sm:w-7 w-5" />
