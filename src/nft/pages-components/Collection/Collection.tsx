...
const Collection = () => {
    ...
    return (
        <div className="2xl1:px-28 pt-11 xl1:px-24 lg1:px-20 md1:px-16 sm1:px-12 xs:px-8 1xs:px-4 px-2 pb-20 flex flex-col">
            ...
            <div className="flex flex-col xl:flex-row justify-between xl:gap-12 md:gap-8 gap-4 xl:mb-8 md:mb-6 mb-4">
                <div className="flex flex-col xs:flex-row 2xl:px-12 lg:px-8 md:px-6 sm:px-4 px-2 2xl:py-16 lg:py-12 md:py-9 sm:py-6 py-3 rounded-lg gap-8 bg-app-black xl:w-1/2 w-full">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing</div>
            ...
            <div className="flex justify-center items-center">
                <div
                    ...
                    onClick={() => navigate.push("/mycollection")}
                >
                    CREATE COLLECTION
                </div>
            </div>
