            ...
            <div className="flex flex-col items-center">
                ...
                <div className="bg-app-black flex flex-col lg:px-12 md:px-8 sm:px-5 px-3 lg:py-12 md:py-8 py-5 xl:w-3/4 w-full rounded-md">
                    <div
                        className={
                            (locked ? "mb-4" : "mb-12") +
                            " 2xl:text-4xl xl:text-3xl lg:text-2xl md:text-xl text-lg font-medium"
                        }
                    >
                        CREATE STAKING
                    </div>
                        ...
                        <div className="sm:w-1/2 w-full mt-8">
                            ...
                            <div className="flex flex-col sm:flex-row sm:gap-6 gap-4 sm:mt-9 mt-6">
                                <div className="flex flex-col gap-1 sm:w-1/3 w-full">
                                    <div>ARP:</div>
                                    <div className="bg-app-black-button rounded-md flex justify-center py-5">8%</div>
                                </div>
                                <div className="flex flex-col gap-1 sm:w-1/3 w-full">
                                    <div>Days:</div>
                                    <div className="bg-app-black-button rounded-md flex justify-center py-5">120</div>
                                </div>
                                <div className={(locked ? "hidden" : "") + " flex flex-col gap-1 sm:w-1/3 w-full"}>
                                    <div>Early FEE:</div>
                                    <div className="bg-app-black-button rounded-md flex justify-center py-5">0.8%</div>
                                </div>
                            </div>
                        </div>
