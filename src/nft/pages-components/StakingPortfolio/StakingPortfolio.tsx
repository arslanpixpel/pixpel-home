...
const StakingPortfolio = () => {
    ...
    return (
        <div className="flex pt-11 flex-col pb-[80px] 2xl:px-32 xl:px-24 lg:px-16 md:px-12 sm:px-8 px-4">
            <div className="flex justify-between items-end mb-5">
                <div
                    className="flex lg:py-3 sm:py-2 py-1 lg:px-3 sm:px-2 px-1 bg-app-black-button rounded-md cursor-pointer hover:bg-app-blue"
                ...
                <div className="xl:text-4xl lg:text-3xl sm:text-2xl text-xl font-semibold">STAKING PORTFOLIO</div>
                <div />
            </div>
