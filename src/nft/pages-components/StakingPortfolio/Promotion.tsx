    ...
    return (
        <div className="flex flex-col pb-56">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-3">
                <div className="flex flex-col sm:flex-row gap-7 lg:w-1/2 w-full">
                    <div className="sm:w-1/4 md:w-1/3 w-full">
                        <DropDownButton
                            ...
                            fontSize={""}
                            textColor={""} setState={undefined} setCustomState={undefined} property={undefined}                        />
                    </div>
                ...
                <div className="bg-app-blue flex px-24 py-4 rounded-md cursor-pointer w-max">BOOST</div>
            </div>
            ...
            <div className="flex justify-center text-3xl font-semibold mb-6">Investors</div>
            ...
            <div className="mt-12 mb-6 text-3xl font-semibold flex justify-center">Graph</div>
            ...
            <div className="mt-12 mb-6 flex justify-center text-3xl font-semibold">Status</div>
