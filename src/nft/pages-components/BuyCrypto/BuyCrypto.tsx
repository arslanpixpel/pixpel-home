...
interface buttonList {
    ...
    title: string;
    buttonStyle: string;
    otherSelectedState?: number;
    anotherSelectedState?: number;
}
...
function BuyCrypto() {
    ...
    }, [context.buyCryptoState, context.p2PState, context.depositState, context.orderBuyState, context.orderSellState]);
    ...
    return (
        <div
            className={(context.buyCryptoState === 1 ? "" : " items-center ") + " flex flex-col pt-11 my-16"}
        ...
        >
            <div className="flex justify-around w-full ">
                ...
                <div className="font-semibold 2xs:text-[40px] text-[30px] justify-center flex">Buy Crypto</div>
                <div className="w-6 h-6"></div>
            </div>
                    ...
                    return (
                        <div key={idx}>
                            <Button
                                ...
                                fontStyle={"xs:text-xl 1xs:text-lg 2xs:text-xl text-lg font-semibold"}
