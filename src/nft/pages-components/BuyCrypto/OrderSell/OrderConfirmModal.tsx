                        ...
                        <div className="flex items-center min-h-screen px-4 py-8">
                            <div className="items-center relative flex flex-col mx-auto text-lg shadow-lg w-158 bg-app-black rounded-xl sm:p-[50px] xs:p-[40px] 1xs:p-[30px] 2xs:p-[20px] p-[10px]">
                                <div className="flex justify-center w-full mb-8">
                                    <div
                                        className="flex mb-4 border-2 border-red-500 border-dashed rounded-full"
                                        style={{
                                            width: "130px",
                                            height: "130px",
                                            paddingTop: "13px",
                                    ...
                                    >
                                        <div
                                            className="flex items-center justify-center px-2 py-3 bg-red-500 rounded-full"
                                ...
                                <div className="flex w-full mb-5 text-lg font-mediumtext-[#717A8B]  1xs:w-11/12">
                                    ATTENTION! Please be sure to LOG IN THE RECEIVING (e.g. Banks/eWallet) ACCOUNT to
                                ...
                                <div className="flex flex-row w-full gap-2 mb-16 1xs:w-2/3">
                                    ...
                                    <div className="flex w-full text-sm font-mediumtext-[#717A8B] ">
                                ...
                                <div className="flex flex-col justify-center w-full gap-5 1xs:flex-row 1xs:w-11/12">
                                    <Button
                                        title={"Cancel"}
                                        buttonStyle={"h-16 1xs:w-1/2 w-full"}
                                        onClick={() => props.setShowModal(false)}
                                        fontStyle={""}
                                        selected={false}
                                        classes={""}
