...
import SUS from "@public/assets/images/Frame.svg";
import PaymentMethod from "./PaymentMethod";
import Tick from "@public/assets/images/UserHome/capture-check.png";
        ...
        <div className="flex justify-center w-full mt-10">
            <div className="w-4/5">
                <div className="flex flex-col justify-start gap-2 mb-5 2xs:flex-row">
                    ...
                    <div className="flex items-end text-sm text-gray-500">Successfully received 1 BTC</div>
                </div>
