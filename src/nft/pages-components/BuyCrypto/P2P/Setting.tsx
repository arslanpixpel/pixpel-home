...
import { FiatList, PaymentList } from "@nft/components/Crypto/dataList";
        ...
        <div className="flex flex-col justify-center w-full gap-5 sm:flex-row shrink-0 2xs:w-auto">
            <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center h-16 px-3 py-2 rounded bg-app-black-button">
                    <input
                        className="flex w-full text-smtext-[#717A8B]  2xs:w-max bg-app-black-button"
                        placeholder="Enter Amount"
                    ></input>
                    <div className="px-3 mr-2 text-lg border-r-2 border-gray-500 ">UAH</div>
