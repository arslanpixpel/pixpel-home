        ...
        <div className="flex flex-col w-full mb-5">
            <div className="flex flex-row pb-2 text-lg border-b-2 border-gray-500 md:w-full shrink-0 w-160">
                ...
                <div className="flex justify-end w-20 lg:w-1/12 shrink-0">
                    <Button
                        title={"Sell BTC"}
                        buttonStyle={" w-28 h-14 bg-red-500"}
                        onClick={() => {
                            setShowSellBTC(true);
                        }}
                        fontStyle={""}
            ...
            {showSellBTC ? (
                <div className="flex flex-col justify-center gap-5 mt-10 2md:flex-row">
                    <div className="flex p-10 text-gray-500 md:w-full 2md:w-1/2 rounded-xl bg-app-black h-max w-160">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Volutpat sit mauris volutpat lorem
                        egestas ullamcorper. Volutpat sed sollicitudin lacus viverra phasellus feugiat augue facilisis.
                        Elit turpis bibendum amet auctor interdum et amet sed facilisi. Neque, sed nec donec nam lorem
                        pellentesque enim aliquam dui. Aliquam ut viverra egestas quis id dictumst. Non diam erat
                        tristique amet, est. Morbi massa fusce urna et dignissim. Lorem ac phasellus donec sem. Enim, ut
                        hac nulla amet. Sed a adipiscing lectus in congue purus gravida. Nisl nibh aliquam eget morbi
                        tempus. Enim neque, ut et nisl egestas condimentum.
                    </div>
                    <div className="flex flex-col p-10 md:w-full 2md:w-1/2 rounded-xl bg-app-black h-max w-160">
                        ...
                        <div className="flex flex-row gap-5">
                            ...
                            <Button
                                title={"Sell BTC"}
                                buttonStyle={"w-1/2 h-16 bg-red-500"}
                                onClick={() => {
                                    context.setBuyCryptoState?.(6);
                                }}
                                fontStyle={""}
                                selected={false}
                                classes={""}
