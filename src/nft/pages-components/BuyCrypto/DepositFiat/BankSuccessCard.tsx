    ...
    return (
        <div className="flex flex-col items-center w-11/12 1xs:pt-[50px] 1xs:pb-[65px] 2xs:pt-[35px] 2xs:pb-[45px] pt-[20px] pb-[30px] bg-app-black rounded-xl xs:w-[521px] mt-32">
            ...
            <div className="flex justify-center mb-8">
                <div className="text-2xl font-semibold">27.13898 USDT</div>
            </div>
            <div className="flex justify-center">
                <div className="text-xl font-semibold 2xs:text-2xl">Deposited Successfully</div>
            </div>
            <div className="flex justify-center">
                <div className="text-lg font-normal text-gray-500 mb-[53px]">In your account</div>
            </div>
            <Button
                title={"Ok"}
                selected={true}
                buttonStyle={" w-[203px] h-[67px]"}
                fontStyle={" text-lg font-medium "}
