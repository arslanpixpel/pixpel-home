...
const NotVerified = () => {
    ...
    const userDataDev = userData?.developer;
    const handleModel = () => {
    ...
    const handleFileUpload = async () => {
        ...
        await upload.then(async (err: any) => {
            ...
            await axios
                .put(`/developers/update/${userDataDev?.id}`, {
                    name: `${name ? name : userDataDev?.name}`,
                    email: `${email ? email : userDataDev?.email}`,
                    wallet: `${
                        userDataDev?.wallet ? userDataDev?.wallet : "4dgSpWaZf4Z5yDFE5hb6XpaioDv6kao7UF3wvZiMbFkynSdh1A"
                    }`,
                ...
                .then((res: any) => {
                    ...
                    console.log(devData);
                    setTempData?.({ developer: { ...devData } });
                    console.log("Changed", tempData);
                    setProcess(true);
                    navigate.push("/developer/profile");
                })
                .catch((e) => {
        ...
        <div className="flex pt-11 flex-col px-56 pb-56 max-xl:px-10 max-xl:pb-10">
            ...
            <div className="flex gap-10 bg-app-black px-32 py-14 mb-20 mt-[40px] max-xl:px-10 max-xl:justify-center  max-xl:flex-wrap">
                <div className="flex flex-col gap-1 items-center">
                    <div
                        style={{
                            backgroundImage: `${userImg ? `url(${URL.createObjectURL(userImg.img)})` : "#29313C"}`,
                        ...
                        onClick={handleModel}
                        className={`text-[18px] leading-normal border-app-black w-44 h-44 flex-none rounded-full flex justify-center items-center text-2xl font-medium ${
                            userImg ? "border-8" : ""
                        }`}
                    >
                        <div className={`m-0 ${userImg ? "hidden" : ""}`}>
                            <img
                                ...
                                src={
                                    toggleImg ? "/icons/create_rocket_plus_hover.png" : "/icons/create_rocket_plus.png"
                                }
                            />
                        </div>
                    </div>
                    <div className="text-[#45515f] font-poppins text-[24px] font-normal mt-[30px]">
                ...
                <div className="flex gap-24 justify-between w-full max-xl:flex-wrap max- max-xl:justify-center ">
                    <div className="flex flex-col gap-3 w-1/2">
                        ...
                        <div className="flex flex-col gap-1 text-[18px] font-semibold leading-normal max-xl:flex-wrap">
                            ...
                            <input
                                className="bg-app-black-button h-16 rounded-lg px-3"
                                placeholder={userDataDev ? userDataDev?.email : "Dev@Dev.com"}
                                value={email}
                    ...
                    <div className="flex flex-col gap-3 w-1/2">
                        <div className="flex flex-col gap-1 text-[18px] font-semibold leading-normal max-xl:flex-wrap">
                            ...
                            <input
                                className="bg-app-black-button h-16 rounded-lg px-3"
                                placeholder={userDataDev ? userDataDev?.contact_details : "92-8888000"}
                                value={phone}
                                onChange={(e: any) => {
                        ...
                        <div className="flex flex-col gap-1 text-[18px] font-semibold leading-normal max-xl:flex-wrap">
                            ...
                            <input
                                className="bg-app-black-button h-16 rounded-lg px-3"
                                placeholder={userDataDev ? userDataDev?.address : "abc at abc"}
                                value={address}
                                onChange={(e: any) => {
                ...
                <div className="flex flex-col gap-8 w-1/2">
                    <div className="py-7 px-12 bg-app-black max-xl:w-[80vw] rounded-lg text-[24px] max-xl:flex-wrap font-medium leading-normal flex justify-between">
                        ...
                        <span className="max-xl:text-center">
                            {userDataDev !== null ? userDataDev?.dateoflaunch.substring(0, 10) : "03/Nov/2023"}
                        </span>
                    </div>
                    <div className="max-xl:w-[80vw] py-7 px-12 bg-app-black rounded-lg max-xl:justify-between max-md:justify-center max-xl:flex-wrap text-[24px] font-medium leading-normal flex justify-between">
                        ...
                        <span className="max-xl:text-center">
                            {userDataDev !== null ? (
                                <input
                                    className="bg-app-black text-right rounded-lg text-[24px] font-medium leading-normal max-xl:text-center"
                                    placeholder={userDataDev?.country}
                                    value={country}
                                    onChange={(e: any) => {
                    ...
                    <div className="max-xl:w-[80vw] py-7 px-12 bg-app-black rounded-lg max-xl:justify-between max-md:justify-center max-xl:flex-wrap text-[24px] font-medium leading-normal flex justify-between">
                        ...
                        <span className="max-xl:text-center">
                            {userDataDev !== null ? (
                                <input
                                    className="bg-app-black text-right rounded-lg text-[24px] font-medium leading-normal max-xl:text-center"
                                    placeholder={userDataDev?.shareholders}
                                    value={shareHolders}
                                    onChange={(e: any) => {
                    ...
                    <div className="max-xl:w-[80vw] py-7 px-12 bg-app-black rounded-lg max-xl:justify-between max-md:justify-center max-xl:flex-wrap text-[24px] font-medium leading-normal flex justify-between">
                        ...
                        <span className="max-xl:text-center">
                            {userDataDev !== null ? (
                                <input className="bg-app-black text-right rounded-lg text-[24px] font-medium leading-normal max-xl:text-center" />
                            ) : (
                                "Juan"
                            )}
                        </span>
                    ...
                    <div className=" h-21 max-xl:w-[80vw] items-center pl-12 bg-app-black max-xl:flex-wrap max-xl:justify-between max-md:justify-center rounded-lg text-[24px] font-medium leading-normal justify-between flex gap-5">
                        ...
                        <div className="w-1/6 left-[-20px] relative">
                            <DropDownButton
                                ...
                                fontSize={""}
                                textColor={""}
                                setState={setWillBeLaunchedInPixPel}
                    ...
                    <div className="max-xl:w-[80vw] py-7 px-12 bg-app-black rounded-lg max-xl:justify-between max-md:justify-center max-xl:flex-wrap text-[24px] font-medium leading-normal flex justify-between">
                        ...
                        <span className="max-xl:text-center">
                            {userDataDev !== null ? (
                                <input
                                    className="bg-app-black text-right rounded-lg text-[24px] font-medium leading-normal max-xl:text-center"
                                    placeholder={userDataDev?.legalname}
                                    value={legalName}
                                    onChange={(e: any) => {
                    ...
                    <div className="max-xl:w-[80vw] py-7 px-12 bg-app-black rounded-lg max-xl:justify-between max-md:justify-center max-xl:flex-wrap text-[24px] font-medium leading-normal flex justify-between">
                        ...
                        <span className="max-xl:text-center">
                            {userDataDev !== null ? (
                                <input
                                    className="bg-app-black text-right rounded-lg text-[24px] font-medium leading-normal max-xl:text-center"
                                    placeholder={userDataDev?.perpercentage}
                                    value={perPercentage}
                                    onChange={(e: any) => {
                                        setPerPercentage(e.target.value);
                                    }}
                                />
                            ) : (
                                "30%"
                    ...
                    <div className="max-xl:w-[80vw] py-7 px-12 bg-app-black rounded-lg max-xl:justify-between max-md:justify-center max-xl:flex-wrap text-[24px] font-medium leading-normal flex justify-between">
                        ...
                        <span className="max-xl:text-center">
                            {userDataDev !== null ? (
                                <input
                                    className="bg-app-black text-right rounded-lg text-[24px] font-medium leading-normal max-xl:text-center"
                                    placeholder={userDataDev?.percentage}
                                    value={percentage}
                                    onChange={(e: any) => {
            ...
            <div className="mt-[31px]">
                <button
                    className="flex bg-[#2EBD85] rounded-[10px] px-[30px] py-[15px] items-center gap-x-[5px] text-[#FFFFFF] text-[18px] hover:bg-[#1FF19F]"
                    onClick={() => {
                        navigate.push("/developer/verification");
                    }}
                >
                    <AiOutlinePlus /> More
                </button>
