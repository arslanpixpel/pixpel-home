...
const Overview = () => {
    return (
        <div className="mt-28 flex flex-col">
            ...
            <div className="flex justify-center text-3xl font-medium">Account Data</div>
            ...
            <div className="flex justify-between gap-5">
                <div className="flex flex-col gap-4 w-1/4">
                    ...
                    <div className="bg-app-black rounded-md py-5 px-7 text-smtext-[#717A8B] ">2.214.415</div>
                </div>
                <div className="flex flex-col gap-4 w-1/4">
            ...
            <div className="flex justify-center my-20">
                <div className="flex px-24 py-5 bg-app-blue rounded-md cursor-pointer">SAVE</div>
            </div>
        </div>
    );
};
