...
import { FiatList } from "@nft/components/Crypto/dataList";
import DropDownButton from "@nft/components/DropDown/DropDownButton";
import Supplies from "@nft/components/TokenRoom/Supplies";
import CreateModal from "@nft/components/TokenRoom/CreateModal";
    ...
    return (
        <>
            <div className="2xl:mt-28 xl:mt-20 md:mt-12 sm:mt-8 mt-4">
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between 2xl:gap-36 xl:gap-20 lg:gap-8 gap-4">
                        ...
                        <div className="lg:w-1/3 w-full flex bg-app-black-button rounded-md xl:pl-6 lg:pl-4 pl-2">
                            <div className="text-lg flex items-center 2xl:w-3/4 lg:w-3/5 w-3/5">Supply Division</div>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between 2xl:gap-36 xl:gap-20 lg:gap-8 gap-4">
                        ...
                        <div className="lg:w-1/3 w-full px-6 items-center flex text-xl gap-2">
                            Description:
                            <div className="text-gray-500 text-sm">A short description of your token</div>
                        </div>
                ...
                <div className="mt-28 text-3xl flex justify-center font-medium mb-16">Supplies</div>
                ...
                <div className="my-16 flex justify-center text-3xl font-medium">RESERVE</div>
                <div className="flex justify-between gap-32 py-10 px-16 bg-app-black mb-20">
                    <div className="flex flex-col w-1/3">
                        ...
                        setState={undefined} setCustomState={undefined} property={undefined}
                            ...
                            textColor={""}
                        />
                        <div className="border-b-2 border-app-black text-3xl mt-16 mb-11 pb-1 w-max">Description</div>
