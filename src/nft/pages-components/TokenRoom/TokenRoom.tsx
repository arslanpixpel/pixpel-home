...
const TokenRoom = () => {
    ...
    return (
        <div className="flex flex-col pt-11 2xl:px-32 xl:px-24 lg:px-16 md:px-12 sm:px-8 px-4">
            ...
            <div className="flex flex-col lg:flex-row gap-3 justify-between">
                ...
                <div className="bg-app-green px-8 py-4 rounded-xl cursor-pointer w-max">+ ADD LOGO</div>
            </div>
            {temp}
        </div>
    );
