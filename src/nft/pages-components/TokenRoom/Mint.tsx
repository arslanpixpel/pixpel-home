...
import AddBankModal from "@nft/components/Wallet/Modal/AddBankModal";
import SuccessMintModal from "@nft/components/TokenRoom/SuccessMintModal";
import { useRouter } from "next/router";

const Mint = () => {
    const [showBankModal, setShowBankModal] = useState<boolean | undefined>(false);
    const [showMintModal, setShowMintModal] = useState<boolean | undefined>(false);
    const navigate = useRouter();
    return (
        <>
            <div className="px-32 pt-11 flex flex-col">
            ...
            {<SuccessMintModal showModal={showMintModal} setShowModal={setShowMintModal} />}
        </>
    );
};
