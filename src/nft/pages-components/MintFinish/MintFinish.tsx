...
import MintFinishImage from "@public/assets/images/market/inventory.png";
import NFTDetail from "../../components/Developer/NFTDetail";
import NFTDetailWithIcon from "../../components/Developer/NFTDetailWithIcon";
import image from "@public/assets/images/UserHome/avax.png";
...
const MintFinish = () => {
    ...
    return (
        <>
            <div className="flex flex-col pt-11 px-28 pb-20">
                <div className="flex gap-12 justify-between mb-20">
                    <div className="flex w-1/2">
                        <Image src={MintFinishImage} alt="NFT" className="w-full" />
                    </div>
                    <div className="flex flex-col w-1/2 gap-8">
                        ...
                        <div className="flex gap-5">
                            <NFTDetail title="QTY:" content="500" color={""} />
                            <NFTDetail title="QTY:" content="200" color={""} />
                            <NFTDetail title="QTY:" content="100" color={""} />
                        </div>
                        <div className="flex gap-5">
                            <NFTDetailWithIcon title="Price:" image={image} content="472 249" color={""} />
                            <NFTDetail title="Duration:" content="500" color="text-gray-500" />
                            <NFTDetailWithIcon title="Price:" image={image} content="200 PIXP" color={""} />
                        </div>
                        <div className="flex gap-5">
                            <NFTDetail title="Duration:" content="500" color="text-gray-500" />
                            <div className="w-1/3" />
                        ...
                        <div className="flex flex-col rounded-lg py-10 px-10 items-center justify-center bg-app-black">
                            ...
                            <div className="overflow-auto relative mt-10 w-full">
                                <table className="table-auto">
                                    <thead>
                                        <tr>
                                            <td className=" text-[#717A8B]  px-6">Price</td>
                                            <td className=" text-[#717A8B]  px-6">USD</td>
                                            <td className=" text-[#717A8B]  px-6">Type</td>
                                            <td className=" text-[#717A8B]  w-1/5 px-6">Date</td>
                                        </tr>
                                    </thead>
                                        ...
                                        {Listing.map((menu, idx) => {
                                            return (
                                                <tr
                                                    key={idx}
                                                    className={
                                                        idx !== Listing.length - 1 ? "border-b-2 border-app-black" : ""
                                                    }
                                                >
                            ...
                            <div className="overflow-auto relative mt-10 w-full">
                                <table className="table-auto">
                                    <thead>
                                        <tr>
                                            <td className=" text-[#717A8B]  px-6">Price</td>
                                            <td className=" text-[#717A8B]  px-6">USER</td>
                                            <td className=" text-[#717A8B]  px-6">Type</td>
                                            <td className=" text-[#717A8B]  w-1/5 px-6">Date</td>
                                        </tr>
                                    </thead>
                                        ...
                                        {Offers.map((menu, idx) => {
                                            return (
                                                <tr
                                                    key={idx}
                                                    className={
                                                        idx !== Offers.length - 1 ? "border-b-2 border-app-black" : ""
                                                    }
                                                >
                                                    <td className="py-5 px-6">{menu.Price}</td>
            ...
            {<ListNFTModal showModal={showListNFTModal} setShowModal={setShowListNFTModal} />}
            {<WrapNFTModal showModal={showWrapNFTModal} setShowModal={setShowWrapNFTModal} />}
            {<FixPriceModal showModal={showFixPriceModal} setShowModal={setShowFixPriceModal} />}
        </>
    );
};
