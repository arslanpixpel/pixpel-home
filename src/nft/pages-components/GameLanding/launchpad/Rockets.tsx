            ...
            <div className="grid mt-14">
                <div className="flex flex-wrap max-preferencemd:gap-y-8 max-preferencemd:justify-center justify-between items-center">
                    <div className="flex flex-col basis-[content]">
                        <h3 className="text-3xl font-semibold uppercase">1 CCD = {`1000`} PIXP</h3>
                    ...
                    <div className="flex flex-col max-1xs:shrink 1xs:basis-[content]">
                                ...
                                <>
                                    <Form form={form} className="flex">
                                        ...
                                        <button
                                            disabled={loading}
                                            className={
                                                "text-lg  font-bold text-black px-6 py-1 rounded-xl ml-2 my-[10px] bg-app-yellow hover:bg-app-yellow-hover"
                                            }
                                        >
                                            Pay
                                        </button>
                        ...
                        <div className="flex justify-center mt-2">
                            <p className="text-[14px] font-medium text-app-black-duration">{`Max Amount 10k CCD - Min Amount 1k CCD`}</p>
                        </div>
                    </div>
                    <div className="flex flex-col max-1xs:shrink 1xs:basis-[content]">
