...
const Stacking = () => {
    ...
    return (
        <div className="flex pt-11 flex-col gap-3 2xl:px-16 xl:px-12 lg:px-9 md:px-6 sm:px-4 px-3 2xl:pb-8 xl:pb-7 lg:pb-6 md:pb-5 sm:pb-4 pb-3">
                                ...
                                <tr key={idx}>
                                    <td className="py-3">
                                        <div className="flex gap-2 items-center">
                                            <Image src={staking.img} alt="token" fill className="xl:h-10 md:h-7 h-4" />
