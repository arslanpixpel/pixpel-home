...
import { withdrawCloseModal } from "@nft/actions/withdraw";
import { useAppDispatch, useAppSelector } from "@nft/hooks";

export default function WithdrawalModal() {
    const selector = useAppSelector((state) => state.withdraw);
                            ...
                            <div className="relative flex flex-col px-10 py-10 mx-auto text-lg shadow-lg bg-app-black-modal rounded-xl">
                                ...
                                <div className="flex flex-col px-8 py-5 mb-5 rounded-md bg-app-black">
                                    <div className="flex flex-row justify-start">
                                        <div className="text-base font-medium w-36 text-slate-400">Amount</div>
                                        <div className="flex-none text-base font-medium w-93">
                                            Receive 19.000000 USDT (Network fee 1 UST)
                                        </div>
                                    </div>
                                    <div className="flex flex-row justify-start">
                                        <div className="text-base font-medium w-36 text-slate-400">Address</div>
                                        <div className="flex-none text-base font-medium w-93">
                                            GIBIoefwf8ef8aw9HU8v8ebfqbjwq
                                        </div>
                                    </div>
                                    <div className="flex flex-row justify-start">
                                        <div className="text-base font-medium w-36 text-slate-400">Network</div>
                                        <div className="flex-none text-base font-medium w-93">Tron (TRC20)</div>
                                    </div>
                                    <div className="flex flex-row justify-start">
                                        <div className="text-base font-medium w-36 text-slate-400">Source</div>
                                        <div className="flex-none text-base font-medium w-93">Funding Wallet</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-row items-center gap-5 mx-5 mb-8">
                                    <div className="w-3 h-3 bg-blue-700 rounded-full"></div>
                                    <div className="text-base font-medium">Transactions cannot be cancelled</div>
                                </div>
