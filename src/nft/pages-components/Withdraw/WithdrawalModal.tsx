...
export default function WithdrawalModal(props: WithdrawalModal) {
    return (
        <>
            {props.showModal ? (
                <>
                            ...
                            <div className="relative flex flex-col w-full px-4 py-4 mx-auto text-lg shadow-lg 2xs:py-10 2xs:px-10 bg-app-black-modal rounded-xl sm:w-auto">
                                ...
                                <div className="flex flex-col px-4 py-3 mb-5 text-xs rounded-md 2xs:py-5 2xs:px-8 2xs:text-base bg-app-black">
                                    <div className="flex flex-row justify-between">
                                        <div className="flex-none w-16 font-medium 2xs:w-20 text-slate-400">Amount</div>
                                    ...
                                    <div className="flex flex-row justify-between">
                                        ...
                                        <div className="font-medium break-all w-93">GIBIoefwf8ef8aw9HU8v8ebfqbjwq</div>
                                    </div>
                                    <div className="flex flex-row justify-between">
                                        <div className="flex-none w-16 font-medium 2xs:w-20 text-slate-400">
                                            Network
                                        </div>
                                        <div className="font-medium w-93">Tron (TRC20)</div>
                                    </div>
                                    <div className="flex flex-row justify-between">
                                        <div className="flex-none w-16 font-medium 2xs:w-20 text-slate-400">Source</div>
                                        <div className="font-medium w-93">Funding Wallet</div>
                                    </div>
                                </div>
