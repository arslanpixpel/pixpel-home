...
import { collectionList, subCollectionList, statsList, ChainList } from "./dataList";
...
const CreateNFT = () => {
    ...
    return (
        <>
            <div className="flex flex-col px-28 pt-11 pb-20">
                <div className="text-3xl gap-12 mb-8">Create a New NFT</div>
                <div className="flex gap-16 mb-3">
                    <Image src={NFT} alt="NFT" className="rounded-md w-7/12 h-137"></Image>
                    <div className="flex flex-col w-5/12">
                        <div className="mb-2 text-xl">Name:</div>
                        <input className="px-10 py-5 bg-app-black rounded-lg mb-20" placeholder="Write your name..." />
                ...
                <div className="flex justify-between gap-10 w-full mb-20">
                    <div className="flex flex-col gap-3 w-1/2">
                        <div>Supply:</div>
                        <input className="py-5 px-10 rounded-xl bg-app-black text-lg" placeholder="The Warrior" />
                    </div>
                    <div className="flex flex-col gap-3 w-1/2">
                        <div>Blockchain:</div>
            ...
            {<SkillsModal showModal={showSkillsModal} setShowModal={setShowSkillsModal} />}
            {<AddPropertiesModal showModal={showAddPropertiesModal} setShowModal={setShowAddPropertiesModal} />}
            {<MintAreaModal showModal={showMintAreaModal} setShowModal={setShowMintAreaModal} />}
        </>
    );
};
