...
const SelectWorking = (props: SelectWorkingTypes) => {
    return (
        <div className="bg-app-black 2xl1:px-28 xl1:px-24 lg1:px-20 md1:px-16 sm1:px-12 xs:px-8 px-4 xl:py-20 lg:py-16 md:py-12 sm:py-8 py-6 rounded-3xl">
            <div className="lg:w-3/5 w-full">
                <div className="3xl1:text-6xl 2xl1:text-5xl xl1:text-4xl lg1:text-3xl md1:text-2xl sm1:text-xl xs:text-lg text-base mb-2 font-semibold leading-relaxed">
                    {props.title}
                </div>
                <div className="text-gray-500 xl:text-lg md:text-base text-sm xl:mb-16 lg:mb-12 md:mb-9 sm:mb-6 mb-3">
                    {props.content}
                </div>
                <div
