...
const CheckboxDropDownN = ({ initialContent, contentList, clicked }: CheckboxDropDownProps) => {
                                ...
                                {contentList?.map((content, idx) => {
                                    return (
                                        <div key={idx} className="flex gap-2 px-3 py-1 hover:text-app-blue">
                                            <input type="checkbox" />
                                            <label className="text-base font-medium">{content.title}</label>
                                        </div>
                                    );
                                })}
                            </div>
...
export default CheckboxDropDownN;
