...
interface WrapNFTModal {
    showModal: boolean;
    setShowModal: (val: boolean) => void;
}
const WrapNFTModal = ({ showModal, setShowModal }: WrapNFTModal) => {
    return (
        <>
            {showModal ? (
                <>
                    <div className="fixed inset-0 z-10 overflow-x-auto">
                        ...
                        <div className="flex items-center px-4 py-6 min-h-screen">
                            <div className="relative flex flex-col w-full max-w-xl mx-auto bg-app-black-modal rounded-xl shadow-lg md:px-12 py-12 text-lg">
                                <div className="flex items-center justify-center mb-6 text-2xl">WRAP NFT IN A BOX</div>
                                ...
                                <div className="flex justify-endtext-[#717A8B]  text-sm mb-5">
