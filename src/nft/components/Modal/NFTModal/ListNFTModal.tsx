...
const ListNFTModal = ({ showModal, setShowModal }: ListNFTModal) => {
    return (
        <>
            {showModal ? (
                <>
                    <div className="fixed inset-0 z-10 overflow-x-auto">
                        ...
                        <div className="flex items-center px-4 py-6 min-h-screen">
                            <div className="relative flex flex-col w-full max-w-xl mx-auto bg-app-black-modal rounded-xl shadow-lg md:px-12 py-12 text-lg">
                                <div className="flex items-center justify-center mb-6 text-2xl">List NFT AUCTION</div>
                                ...
                                <TokenDropdownInput
                                    ...
                                    textColor={""}
                                />
                                <div className="flex text justify-endtext-[#717A8B]  mt-2">USDT $2,766</div>
                                ...
                                <div className="flex justify-endtext-[#717A8B]  text-base mb-5">Remaining: 300</div>
