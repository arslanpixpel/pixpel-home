...
const SkillsModal = ({ showModal, setShowModal }: SkillsModal) => {
                    ...
                    <div className="fixed inset-0 z-10 overflow-x-auto">
                        ...
                        <div className="flex items-center px-4 py-6 min-h-screen">
                            <div className="relative flex flex-col w-full max-w-3xl mx-auto bg-app-black-modal rounded-xl shadow-lg md:px-12 py-12 text-lg">
                                <div className="flex items-center justify-center mb-6 text-2xl">SKILLS</div>
                                <div className=" text-[#717A8B]  flex items-center justify-center mb-8">
                                    Add skills your NFT
                                </div>
                                <div className="mb-4">
                                    ...
                                    <div className="flex gap-8">
                                        <div className="flex flex-col w-5/12">
                                            <input
                                                ...
                                                placeholder="Magic"
                                            />
                                            <input className="py-5 px-5 bg-app-black rounded mb-5" placeholder="Fist" />
                                            <div
                                        ...
                                        <div className="flex flex-col w-5/12">
                                            <input className="py-5 px-5 bg-app-black rounded mb-3" placeholder="100" />
                                            <input className="py-5 px-5 bg-app-black rounded mb-5" placeholder="50" />
                                        </div>
