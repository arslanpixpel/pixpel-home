...
import { CategoryList } from "@nft/pages-components/MysteryBox/dataList";
import WarriorAvatar from "../Avatar/WarriorAvatar";

interface AddWarriorModal {
    showModal: boolean;
    setShowModal: (val: boolean) => void;
}

const AddWarriorModal = ({ showModal, setShowModal }: AddWarriorModal) => {
    return (
        <>
            {showModal ? (
                <>
                        ...
                        <div className="flex items-center px-4 py-6 min-h-screen">
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-5">
                                    <Dropdown initialContent={CategoryList.title} contentList={CategoryList.content} />
                                    <Dropdown initialContent={CategoryList.title} contentList={CategoryList.content} />
                                </div>
                                ...
                                <div className="flex justify-center items-center">
                                    <div className="bg-app-green px-16 py-4 w-max rounded-md cursor-pointer">Add</div>
                                </div>
                            </div>
                        </div>
                    </div>
