        ...
        <div className="add-modal">
            <div className="add-modal-container">
                ...
                <div className="flex flex-col px-12 gap-2">
                    ...
                    <input type="text" className="collection__input px-6" placeholder="PIXP Deposited" />
                </div>
                <div className="flex justify-center">
                    <button className="collection__btn mt-10 w-max font-medium px-16" onClick={props.handleClose}>
                        Save
                    </button>
                </div>
            </div>
