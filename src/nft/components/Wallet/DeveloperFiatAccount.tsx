...
import DeveloperFiatAccountOverview from "./FiatAccount/DeveloperFiatAccountOverview";

const DeveloperFaitAccount = () => {
    ...
    return (
        <>
            <div>
                <DeveloperFiatAccountOverview />
                <div className="flex mt-6 mb-8 gap-4 flex-col 2xs:flex-row">
                    ...
                    <TokenButton title="SWAP" selected={selected === 3} handleClick={handleClick(3)} />
                </div>
                <GamingTable />
            </div>
...
export default DeveloperFaitAccount;
