...
const StartAccountOverview = ({ selected }: Button) => {
    const className = "flex gap-3 items-center pl-5 pr-12 bg-app-black-button h-max rounded-md py-3 w-max";
                ...
                <div className="flex xl:flex-row flex-col xl:items-end md:pr-16 gap-10">
                    <div className="flex md:w-5/6 justify-between flex-col md:flex-row gap-3">
                        <div className="flex flex-col">
                            <div className="text-[18px] font-medium leading-normaltext-[#717A8B]  mb-2">
                                Estimated balance
                            </div>
                        ...
                        <div className="flex flex-col">
                            <div className=" text-[#717A8B]  mb-2 text-[18px] font-medium">{tempBalance}</div>
                            <div className="flex md:flex-row flex-col gap-3 md:items-center pl-5 pr-10 w-full bg-app-black-button py-3 rounded-md">
                                <div className="text-[22px] font-semibold leading-normal ">300.000 PIXP</div>
                                <div className=" text-[#717A8B]  text-[18px] font-medium leading-normal">
                                    = 3,832,194,124.10 TUSD
                    ...
                    <div className="flex">
                        <div className={className + (selected === 0 ? " hidden" : "")}>
                            <Image src={Clock} alt="history" width={24} height={24} />
