...
interface VestingDetail {
    number: number;
}
const VestingDetail = ({ number }: VestingDetail) => {
    return (
        <div className="flex gap-20 border-b-2 border-app-black pb-6">
            <div className="flex flex-col gap-1">
                <div className="text-gray-500">N˚</div>
                <div className="bg-app-black-button rounded-lg w-16 h-16 flex justify-center items-center">
                    {number}
                </div>
            </div>
            <div className="flex flex-col gap-1">
