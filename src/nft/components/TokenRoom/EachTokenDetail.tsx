...
interface EachTokenDetail {
    type: string;
}

const EachTokenDetail = ({ type }: EachTokenDetail) => {
    ...
    return (
        <div className="bg-app-black px-12 py-7 flex justify-between gap-7">
            ...
            <div className="w-1/4 flex flex-col items-center gap-8">
                ...
                <div className="bg-app-blue px-16 py-5 rounded-md cursor-pointer">Launch</div>
                <div className="flex gap-8">
                    <div
                        className="bg-app-blue px-16 py-5 rounded-md cursor-pointer"
                        onClick={() => navigate.push("/tokenroom/mint")}
                    >
                        MINT
                    </div>
                    <div
                        className="bg-app-blue px-16 py-5 rounded-md cursor-pointer"
                        onClick={() => navigate.push("/tokenroom/burn")}
                    >
                        BURN
                    </div>
                </div>
