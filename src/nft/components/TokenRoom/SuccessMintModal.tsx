...
interface SuccessMintModal {
    setShowModal: (val: boolean) => void;
    showModal?: boolean;
}
const SuccessMintModal = ({ showModal, setShowModal }: SuccessMintModal) => {
    return (
        <>
            {showModal ? (
                <>
                    <div className="fixed inset-0 z-10 overflow-x-auto">
                        ...
                        <div className="flex items-center px-4 py-6 min-h-screen">
                            <div className="relative flex flex-col w-full max-w-2xl mx-auto bg-app-black-modal rounded-xl shadow-lg px-16 py-11">
                                ...
                                <div className="text-lg flex justify-center">Supply Name: MAIN</div>
