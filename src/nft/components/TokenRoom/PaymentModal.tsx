...
const PaymentModal = ({ showModal, setShowModal }: PaymentModal) => {
    return (
        <>
            {showModal ? (
                <>
                    <div className="fixed inset-0 z-10 overflow-x-auto">
                        ...
                        <div className="flex items-center px-4 py-6 min-h-screen">
                            <div className="relative flex flex-col w-full max-w-3xl mx-auto bg-app-black rounded-xl shadow-lg py-20">
                                <div className="flex justify-center text-3xl mb-12">PAYMENT</div>
                                <div className="flex justify-between">
                                    <div className="w-1/4" />
                                    <div className="w-1/2 flex flex-col items-center gap-5">
                                        <div className="w-full">
                                            <Calculation title="Create New Token Fee:" cost="20 UDS" />
                                        </div>
                                        <div className="w-full">
