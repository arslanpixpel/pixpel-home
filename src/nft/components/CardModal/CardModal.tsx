...
const CardModal = ({ showModal, setShowModal, data }: CardModal) => {
                            ...
                            <div className="flex flex-col w-3/5">
                                ...
                                <div className="flex flex-col gap-2 mb-6">
                                    <div className="px-8 py-5 flex justify-between bg-app-black-button rounded-lg">
                                        <div>Price</div>
                                        <div className="text-app-blue font-semibold">$31 213 241.942</div>
                                    </div>
                                    <div className="px-8 py-5 flex justify-between bg-app-black-button rounded-lg">
                                        <div>Item Location</div>
                                        <div className="text-app-blue font-semibold">Crypto Bots</div>
                                    </div>
                                    <div className="px-8 py-5 flex justify-between bg-app-black-button rounded-lg">
                                        <div>Blockchain ID</div>
                                        <div className="flex gap-2">
                                            <div className="text-app-blue font-semibold">c47befa...18076d627f</div>
                                            <svg
                                                className="h-5 w-5"
                                                viewBox="0 0 24 24"
                                                fill="none"
